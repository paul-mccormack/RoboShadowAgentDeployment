...
RoboShadow provides an installable agent for monitoring your devices. This is easy to install using the downloadable msi file, a PowerShell script provided by RoboShadow, which can be found [here](https://github.com/paul-mccormack/RoboShadowAgentDeployment/blob/main/RoboShadowAgentInstall.ps1), or if you have Microsoft Intune within your organisation and you need to deploy to your workstations you can utilise the "Deploy RoboShadow With Intune" functionality once you have the integration set-up.  Detailed guidance is available in their [documentation](https://roboshadow.atlassian.net/wiki/spaces/Roboshadow/overview?homepageId=4882647)
